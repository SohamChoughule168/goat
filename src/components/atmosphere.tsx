export default function Atmosphere() {
  return (
    <div aria-hidden="true" className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      />
      <div
        className="aurora absolute right-[-12%] top-[38%] h-[30rem] w-[30rem] rounded-full opacity-[0.12] blur-[120px]"
        style={{ background: "radial-gradient(circle at 60% 40%, #3d7bd6, transparent 65%)", animation: "drift-b 32s ease-in-out infinite" }}
      />
      <div
        className="aurora absolute bottom-[-18%] left-[28%] h-[36rem] w-[36rem] rounded-full opacity-[0.09] blur-[130px]"
        style={{ background: "radial-gradient(circle at 50% 50%, #8f5be0, transparent 62%)", animation: "drift-c 38s ease-in-out infinite" }}
      />
      <div
