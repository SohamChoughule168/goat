      ...
      <div className="shell">
        ...
        >
          <div className="relative grid md:grid-cols-[1.15fr_1fr]">
            <div className="hairline-grid relative min-h-64 overflow-hidden bg-background p-8 md:min-h-96 md:p-10">
              ...
              <p className="relative mt-6 font-display text-5xl font-medium tracking-tight md:text-7xl">
                PRV
                <span className="text-primary">.</span>
              </p>
              <p className="mt-3 max-w-xs font-serif italic text-muted-foreground">
                Financial services, taken seriously online.
              </p>
            </div>
